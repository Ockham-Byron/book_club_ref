...
class SingleBookHome2 extends StatefulWidget {
  final GroupModel currentGroup;
  final String groupId;
  final AuthModel authModel;
  final UserModel currentUser;
  const SingleBookHome2(
      {Key? key,
  ...
  @override
  _SingleBookHome2State createState() => _SingleBookHome2State();
}

class _SingleBookHome2State extends State<SingleBookHome2> {
